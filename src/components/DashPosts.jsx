        ...
        <>
          <Table hoverable className='shadow-md min-w-full'>
            <Table.Head>
              ...
              <Table.HeadCell className="text-xs sm:text-sm">Image</Table.HeadCell>
              <Table.HeadCell className="text-xs sm:text-sm">Title</Table.HeadCell>
              <Table.HeadCell className="text-xs sm:text-sm hidden sm:table-cell">Category</Table.HeadCell>
              <Table.HeadCell className="text-xs sm:text-sm">Delete</Table.HeadCell>
              <Table.HeadCell className="text-xs sm:text-sm">
                <span>Edit</span>
              </Table.HeadCell>
            </Table.Head>
            {userPosts.map((post) => (
              <Table.Body className='divide-y' key={post._id}>
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  ...
                  <Table.Cell>
                    <Link to={`/post/${post.slug}`}>
                      <img
                        src={post.image}
                        alt={post.title}
                        className='w-16 h-10 sm:w-20 sm:h-10 object-cover bg-gray-500 rounded'
                      />
                    </Link>
                  </Table.Cell>
                  ...
                  <Table.Cell className="text-xs sm:text-sm hidden sm:table-cell">{post.category}</Table.Cell>
                  <Table.Cell>
                    <span
                      onClick={() => {
                        setShowModal(true);
